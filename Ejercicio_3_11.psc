...
Algoritmo Ejercicio_3_11
	...
	// b)
	Escribir "b) El resultado es:  ", 2 div 3 + 3 / 5;
	// c)
	Escribir "c) El resultado es:  ", 9 div 2 / 5;
	// d)
	Escribir "d) El resultado es:  ", 7 mod 5 mod 3;
	// e)
	Escribir "e) El resultado es:  ", 7 mod (5 mod 3);
	// f)
